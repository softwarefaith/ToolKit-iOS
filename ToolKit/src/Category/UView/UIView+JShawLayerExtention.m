...
#import "UIView+JShawLayerExtention.h"

@implementation UIView (JShawLayerExtention)
/*
  周边加阴影，并且同时圆角
*/
        ...
        andCornerRadius:(CGFloat)cornerRadius
{
    ...
    if (view.superview) {
        ...
        NSAssert(NO, @"Add shadowLayer view.superview is nil");
    }
